<script setup>
  ...
  const { columns, queryParams, dataSource, getData, params, loading, pagination, changeTable, delRow } = useTable({
    url: '/web3/mining-pools/list',
    del_url: '/web3/mining-pools',
    cols: [
      { title: '矿池名称', dataIndex: 'name' },
      { title: '支持币种', dataIndex: 'coin' },
      { title: '周期类型', dataIndex: 'cycle' },
      { title: '矿池状态', dataIndex: 'status' },
      { title: '矿池类型', dataIndex: 'cate' },
