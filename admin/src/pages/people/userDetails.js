...
import pledgeIncomeModal from '@/pages/pool/pledgeIncome/modal.js';
import { h } from 'vue';
...
export const useUserDetail = () => {
  ...
  const formConfig = [
    ...
    { label: '是否内部用户', key: 'is_internal', type: 'booleanText', yes: 1, yesText: '是', noText: '否' },
    {
      label: '团队成员',
      key: 'star_down_agent',
      type: 'custom',
        ...
        return h(
          ...
          {},
          {
            default: [
              ...
              createButton('质押收益', () => pledgeIncomeModal(user_id)),
            ],
          }
        );
      },
